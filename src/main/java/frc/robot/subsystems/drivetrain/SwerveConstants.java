...
public final class SwerveConstants {
    ...
    public final class FrontRight {
        ...
        public static final Angle frontRightEncoderOffset = Degrees.of(140.4);
    ...
    public final class BackRight {
        ...
        public static final Angle backRightEncoderOffset = Degrees.of(308.05);
    ...
    public final class BackLeft {
        ...
        public static final Angle backLeftEncoderOffset = Degrees.of(352.3);
    ...
    public final SwerveModuleConstants frontLeftModuleConstants = new SwerveModuleConstants(
            FrontLeft.frontLeftDriveMotorID, FrontLeft.frontLeftAngleMotorID, FrontLeft.frontLeftEncoderID,
            FrontLeft.frontLeftEncoderOffset, FrontLeft.frontLeftDriveMotorInverted,
            FrontLeft.frontLeftAngleMotorInverted, FrontLeft.frontLeftEncoderInverted, FrontLeft.frontLeftX,
            FrontLeft.frontLeftY);
    public final SwerveModuleConstants frontRightModuleConstants = new SwerveModuleConstants(
            FrontRight.frontRightDriveMotorID, FrontRight.frontRightAngleMotorID, FrontRight.frontRightEncoderID,
            FrontRight.frontRightEncoderOffset, FrontRight.frontRightDriveMotorInverted,
            FrontRight.frontRightAngleMotorInverted, FrontRight.frontRightEncoderInverted, FrontRight.frontRightX,
            FrontRight.frontRightY);
    public final SwerveModuleConstants backLeftModuleConstants = new SwerveModuleConstants(
            BackLeft.backLeftDriveMotorID, BackLeft.backLeftAngleMotorID, BackLeft.backLeftEncoderID,
            BackLeft.backLeftEncoderOffset, BackLeft.backLeftDriveMotorInverted, BackLeft.backLeftAngleMotorInverted,
            BackLeft.backLeftEncoderInverted, BackLeft.backLeftX, BackLeft.backLeftY);
    public final SwerveModuleConstants backRightModuleConstants = new SwerveModuleConstants(
            BackRight.backRightDriveMotorID, BackRight.backRightAngleMotorID, BackRight.backRightEncoderID,
            BackRight.backRightEncoderOffset, BackRight.backRightDriveMotorInverted,
            BackRight.backRightAngleMotorInverted, BackRight.backRightEncoderInverted, BackRight.backRightX,
            BackRight.backRightY);
}
